...
climate_dataset = api.get_instrumental([švn", "usa", "aus"])

list1 = ds.as_list()
list2 = ds.as_list(columns=["type", "interval"])  # default  value
list3 = ds.as_list(columns=["type"])
list4 = ds.as_list(columns=["type", čountry"]) 
list5 = ds.as_list(columns=[čountry"])
\end{lstlisting}
\end{center}
\cprotect
...
pretvori v podatkovno tabelo Orange. % TODO: (angl.\ Orange data table).

...
podatkov meteorolo"skih meritev in ``IndicatorAPI'' s katerim dostopamo do 
podatkov raznih indikatorjev stopenj razvoja dr"zav.
...
\begin{itemize}  
  \item Svetovni indikatorji razvoja~ \ref{world_dev_ind} % World Development Indicators, 

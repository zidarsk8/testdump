...
seznami stopnje ogro"zenosti "zivali po dr"zavah \fnurl{http://apiv3.iucnredlist.org/api/v3/docs},    
...
zgodovina meteorolo"skih meritev, \fnurl{http://climatedataapi.worldbank.org/},
razni indikatorji stopenj razvoja dr"zav \fnurl{http://api.worldbank.org/}.
...
%% oblikovati da so primerni za analizo, ima mnogo pomanjkljivosti. Prejeti podatki
...
%% uporabo teh podatkov. S tem bomo omogo"cili raziskovanje teh podatkov "sir"si
